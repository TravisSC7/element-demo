		...
		<div class="na">
			...
			<el-container>
			  <el-aside width="200px">
				  <div class="fdo">
				  	<el-menu default-active="1-4-1" background-color="#304156" text-color="#BFCBD9"
				  		active-text-color="#409EFF" class="el-menu-vertical-demo" :collapse="isCollapse">
				  		<div class="daq">
				  			<img src="../assets/ke.jpg" alt />
				  			<h1>智慧宿管云平台</h1>
				  		</div>
				  		...
				  		<el-submenu v-for="(item, qq) in list" :key="qq" :index="qq+' '">
				  			<template slot="title">
				  				<!-- <i :class="ioo+item.meta.icon"></i> -->
				  				<span slot="title">{{item.meta.title}}</span>
				  			</template>
				  			<el-menu-item-group>
				  				<el-menu-item v-for="(item2, index2) in item.children" :key="index2" :index="qq+''+index2">
...
<style scoped>
	* {
	...
	.dQo {
		position: relative;
		padding: 5px 0;
		box-shadow: 0 0px 5px 3px #f2f4f4;
