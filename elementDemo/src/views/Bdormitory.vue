	...
	export default {
		...
		methods: {
			onSubmit() {
				this.axios({
					method: "get",
					url: "http://122.112.253.28:8095/prod-api/basedata/bdormitory/list?pageNum=1&pageSize=10&buildingNo=" +
			...
			del(index, id) {
				this.axios({
					method: "DELETE",
					url: "http://122.112.253.28:8095/prod-api/basedata/bdormitory/deleteByIds/" +
						id,
					headers: {
						Authorization: window.sessionStorage.token
					}
			...
			Xiugai() {
				this.axios({
					method: "PUT",
					url: "http://122.112.253.28:8095/prod-api/basedata/bdormitory/update/" +
						this.idd,
					headers: {
						Authorization: window.sessionStorage.token
					},
