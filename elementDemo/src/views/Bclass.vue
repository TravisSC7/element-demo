	...
	export default {
		...
		methods: {
			...
			onSubmit() {
				this.axios({
					method: "get",
					url: "http://122.112.253.28:8095/prod-api/basedata/bclass/list?pageNum=1&pageSize=10&className=" +
			...
			del(index, id) {
				this.axios({
					method: "DELETE",
					url: "http://122.112.253.28:8095/prod-api/basedata/bclass/deleteByIds/" +
						id,
					headers: {
						Authorization: window.sessionStorage.token
					}
			...
			Xiugai() {
				this.axios({
					method: "PUT",
					url: "http://122.112.253.28:8095/prod-api/basedata/bclass/update/" +
						this.idd,
					headers: {
						Authorization: window.sessionStorage.token
					},
